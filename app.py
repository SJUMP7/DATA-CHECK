...
def main():
    ...
    with st.sidebar:
        ...
        # ─── Settings & Profile Area (Static layout to prevent overlapping and transparency bugs on mobile) ───
        st.markdown("""
            <style>
            /* API Status Styling */
            .api-status {
    ...
    # ─── Floating Popup Card Menu (Moved OUTSIDE sidebar to avoid mobile clipping and translucent overlay bugs) ───
