...
def _build_prompt() -> str:
    ...
    possible_paths = [
        os.path.join(current_dir, "prompts", "contract_compare.txt"),
        os.path.join(current_dir, "Recheck excel data", "prompts", "contract_compare.txt"),
        os.path.join(os.path.dirname(current_dir), "prompts", "contract_compare.txt"),
        os.path.join(os.getcwd(), "prompts", "contract_compare.txt"),
        os.path.join(os.getcwd(), "Recheck excel data", "prompts", "contract_compare.txt")
    ]
    ...
    return "ERROR: contract_compare.txt not found in any expected paths."
